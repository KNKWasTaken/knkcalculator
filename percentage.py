...
if p.lowercase == 'e':
    print(exit(`Exiting...`)) #Converts p to lowercase and checks if it is 'e'. If it is e then it exits
w = input('Enter Whole:- ') #Take input from user about whole value (input as string)
if w.lowercase == 'e'
    print(exit(`Exiting...`)) #Converts w to lowercase and checks if it is 'e'. If it is e then it exits
